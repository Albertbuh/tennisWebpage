  ...
  return (
    <>
      ...
      <TextMessage image={jumpBoyImage}>
        ...
        <ul>
          <li>Euismod diam, vel venenatis bibendum sodales sem henderit vulputate sagittis</li>
          <li> Nisl senectus sed malesuada donec. Interdum malesuada bibendum imperdiet elementum auctor vitae in.</li>
          <li> Quam purus ornare dictum pharetra. Sed viverra tellus sollicitudin urna, sagitts.</li>
          <li> Sceleresque urna senectus commodo, nam. Donec nibh tempus imperdiet nisi, tincidunt mus egestas nisl nullam.</li>
        </ul></TextMessage>
    </>
  );
}
